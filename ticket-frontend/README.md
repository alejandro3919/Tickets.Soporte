...
1. Levantar el Backend con Laravel 12
Abre una terminal, entra a la carpeta del servidor escribiendo el comando: cd ticket-backend
...
2. Levantar el Frontend con Vue 3 y Vite
